...
def build_executable():
    ...
    # Vérifier les fichiers essentiels dans web_config
    ...
    # Vérifier le fichier temp_config/index.html
    ...
    try:
        ...
        # Déplacer l'exécutable vers le répertoire racine
        ...
        if exe_source.exists():
            ...
            # Déplacer le nouvel exécutable
            print("📦 Déplacement de l'exécutable...")
            shutil.move(str(exe_source), str(exe_dest))
            print(f"✅ Exécutable créé: {exe_dest}")
            
            # Calculer la taille de l'exécutable
            exe_size = exe_dest.stat().st_size / (1024 * 1024)  # Taille en MB
            print(f"📏 Taille de l'exécutable: {exe_size:.2f} MB")
